...
\textbf{Comando} & \textbf{Descripción} \\
\midrule
\cmd{!join \param{canal}} & Hace que el bot se una al canal indicado (PM). \\[0.3em]
\cmd{/invite \param{bot} \param{canal}} & Invita al bot al canal (comando IRC estándar). \\[0.3em]
\bot{} \cmd{sal del canal} & El bot abandona el canal actual. Es temporal: se re-une en el siguiente chequeo periódico o PING. \\[0.3em]
...
\begin{itemize}[nosep,leftmargin=1em]
  \item \cmd{!join \param{canal}} — unir a canal
